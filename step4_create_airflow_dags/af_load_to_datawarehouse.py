...
# This graph is loading data from Staging to DWH, data will be loaded into all DWH tables
# During the initial load, the data will be loaded into all DWH tables, while updating the data - only into some of them

# Mode: CREATE (initial loading) or UPDATE (loading updated data)
